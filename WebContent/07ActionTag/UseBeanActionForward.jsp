...
<body>
 	...
 	<%
 	/*
 		영역에 저장 시 Object형으로 변환되므로 
 		사용 시에는 본래의 형으로 변환해야 한다.
 	*/
 	...
 	<!--  
 	자바코드를 통해 영역에서 객체를 가져온 경우에는 
 	액션태그에서 사용할 수 없다. 반드시 액션태그를 통해 읽어온 객체를
 	액션태그에서 사용해야 한다.
 	-->
 	...
 	<ul>
		...
		<li>이름 :
			<jsp:getProperty property="id" name="member"/></li></li>
	</ul>
</body>
</html>
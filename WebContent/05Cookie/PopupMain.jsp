...
if(cookies!=null){
	...
	for(Cookie c : cookies){
		...
		//쿠키명 중 팝업닫기 관련 항목이 있다면 저장된 값을 가져온다.
...
if(isPopup.equals("on")){//쿠키값이 on이면 레이어팝업창을 띄워준다.
%>
	<script>
		function popClose(){
			...
			/*
			오늘하루열지않음 체크박스를 체크한 후 닫기를 누르면
			JS를 통해 폼값을 전송한다. target을 iFrame으로 설정하여
			페이지 이동이 없는 것(비동기)처럼 보이게 한다.
			*/

...
if(id.length()==0){
%>
	<!-- 로그인 실패 시 리퀘스트영역에 저장된 속성값을 출력함 -->
	<span style="color:red; font-sze:1.5em;">
		로그인 메시지 :
		<%=request.getAttribute("ERROR_MSG")==null ?
				"" : request.getAttribute("ERROR_MSG")%>
	</span>
	<!-- 
		input채그의 하위속성 tabindex
			: 아이디, 패스워드를 입력하기 위해 주로 Tab키를 통해 포커스를 이동하는데
	...
	<table border="1">
		<tr>
			...
			<td>
				...
				<!-- 
					아이디 저장하기에 관련된 쿠키값이 존재한다면 체크박스의
					checked속성을 활성화한다. 
				-->

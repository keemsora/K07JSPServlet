...
DBCP(Database Connection Pool : 커넥션풀)
	...
	자원을 효율적으로 관리할 수 있다. 
	게임에서는 풀링시스템(Pooling System)이라는 용ㅇ어로 사용한다.
...
/*
4. 커넥션풀에 톰캣이 생성해놓은 커넥션객체를 가져다가 사용한다.
*/
Connection conn = source.getConnection();
if(conn!=null)
	out.println("<h2>DBCP 연결 성공</h2>");
else
	out.println("<h2>DBCP 연결 실패</h2>");

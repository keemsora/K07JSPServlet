			...
			<div class="row mb-3">
				<div class="col-6">
					...
					<button type="button" class="btn btn-success"
						onclick="location.href='./DataPassword?mode=delete&idx=${dto.idx}&nowPage=${param.nowPage}&searchColumn=${param.searchColumn}&searchWord=${param.searchWord }';">삭제하기</button>
				</div>

...
<%--
	errorPage 지시어
		...
		사용자에게 보여주지 않게 되므로 사이트에 대한 신뢰도를 높일 수 있다.  
--%>
<%
...
String errorStr = "";
/*
해당 페이지로 폼값을 전송할 때 "나이"부분을 공백상태 혹은
...
<body>
	...
	<span style="color:red; font-size:2em;">
		...
		<% if(ageAfter10 != -1) {%>
			당신의 10년 후 나이는 <%=ageAfter10 %>살 입니다.
		<%} else {%>
			<%=errorStr %>
		<% } %>
	</span>

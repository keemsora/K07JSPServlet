...
<body>
	...
	<!-- groupingUsed의 디폴트값이 true이므로 콤마 출력 -->
	<h3>JSTL 국제화태그로 출력</h3>
	money : <fmt:formatNumber value="${money }" /> -> 10,000
	
	<!-- 콤마를 생략하고 싶을 때는 false로 설정 -->
	<h3>JSTL 국제화태그로 출력 - 천단위 콤마 생략</h3>
	money : <fmt:formatNumber groupingUsed="false" value="${money }" />
	
	<h3>type="currency" 이고 currencySymbol생략 시 - 현재 통화 단위로 출력</h3>
	...
	가격이 <strike>15,000원</strike> ->
		<span style="font-size:1.5em;">${price }</span>으로 내렸어요.
